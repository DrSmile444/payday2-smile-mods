-- За коррекцию перевода спасибо -GoodFarsh-, MaximysKing
-- http://steamcommunity.com/id/goodfarsh/
-- https://steamcommunity.com/id/MaximysKing/
...
PocoLocale._drillNames = {
	...
	process = 'Процесс',
	hold_charge_gun = 'Заряд оружия', -- Henry's Rock
	security_station = 'Взлом' -- Undercover hack
}
